<template>
	<div>
		<v-card class="mx-auto" elevation="3" outlined>
			<v-card class="mx-auto pa-5" align="center" max-width="250px" color="amber lighten-3">
				<h3 class="headline white--text text--accent-2">Recommended</h3>
			</v-card>
			<v-container>
				<v-row no-gutters>
					<v-col
...
export default {
	...
	methods: {
		readData() {
			var url = this.$api + "/item/recommend";
			this.$http
				.get(url, {
					headers: {
