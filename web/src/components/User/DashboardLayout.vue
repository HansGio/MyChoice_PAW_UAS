            ...
            <v-container fluid class="pa-0">
                <v-row>
                    <v-col justify="space-around" class="ml-5">
                        <v-btn text color="primary" router to="/about"
                            >About</v-btn
                        >
                        <base-text class="ml-12"
                            >Email : MyChoice.cs@gmail.com
                        </base-text>
                        <br />
                        <v-btn text color="primary" router to="/contact-us"
                            >Help</v-btn
                        >
                        <base-text class="ml-15"
                            >WhatsApp : 021-235-5313</base-text
                        >
                    </v-col>
                </v-row>
                <v-row>
