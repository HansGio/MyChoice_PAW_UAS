		...
		save() {
			if (this.inputType == "Ubah") {
				let newData = {
					...
					stock_s: this.form.stock_s,
					stock_m: this.form.stock_m,
					stock_l: this.form.stock_l,
					stock_xl: this.form.stock_xl,
					active: this.form.active,
					description: this.form.description,
					price: this.form.price,
					image64: this.form.image64,
				};
				let url = this.$api + "/item/" + this.editId;
				this.load = true;
				this.$http
					.put(url, newData, {
						headers: {
